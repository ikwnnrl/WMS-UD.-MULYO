...
import SolarRestockForm from "./SolarRestockForm";
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                {/* Solar Refill Form */}
                <div className="bg-white dark:bg-slate-900 rounded-xl shadow-sm border border-slate-100 dark:border-slate-800 p-6 mt-6">
                    <h2 className="font-bold text-lg mb-4 text-slate-800 dark:text-slate-100 flex items-center gap-2">
                        ...
                        Isi Ulang Stok Solar
                    </h2>
                    <SolarRestockForm onSuccess={fetchLogs} />
                </div>
            </div>
